...
import com.muhammet.exception.MainServiceException;
...
public class JwtTokenManager {
    ...
    public Optional<Long> getByIdFromToken(String token){
        try{
            ...
            if(decodedToken==null) throw new MainServiceException(ErrorType.GECERSIZ_TOKEN);
            Long authid = decodedToken.getClaim("authid").asLong();
            return  Optional.of(authid);
        }catch (Exception e){
            throw new MainServiceException(ErrorType.GECERSIZ_TOKEN);
        }
    }
